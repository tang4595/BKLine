...
public class BKLineDataUtil {
    public static func calculate(dataList: [BKLineChartModel]) {
    ...
    // 增量更新时计算最后一个数据
    public static func addLastData(dataList: [BKLineChartModel], data: BKLineChartModel) {
        var _dataList = dataList.reversed() as [BKLineChartModel]
    ...
    // 更新最新的数据
    public static func updateLastData(dataList: [BKLineChartModel], data: BKLineChartModel) -> [BKLineChartModel] {
    ...
    public static func calcMA(_ dataList: [BKLineChartModel], isLast: Bool = false) {
        var ma5: CGFloat = 0
        var ma10: CGFloat = 0
        var ma20: CGFloat = 0
        var ma30: CGFloat = 0
    ...
    public static func calcBOLL(_ dataList: [BKLineChartModel], isLast: Bool = false) {
    ...
    public static func calcMACD(_ dataList: [BKLineChartModel], isLast: Bool = false) {
        var ema12: CGFloat = 0
        var ema26: CGFloat = 0
        var dif: CGFloat = 0
        var dea: CGFloat = 0
    ...
    public static func calcVolumeMA(_ dataList: [BKLineChartModel], isLast: Bool = false) {
    ...
    public static func calcRSI(_ dataList: [BKLineChartModel], isLast: Bool = false) {
        var rsi: CGFloat = 0
    ...
    public static func calcKDJ(_ dataList: [BKLineChartModel], isLast: Bool = false) {
        var k: CGFloat = 0
        var d: CGFloat = 0
    ...
    public static func calcWR(_ dataList: [BKLineChartModel], isLast: Bool = false) {
        var i_index = 0
